...
const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    answer:
      '홈페이지에서 원하시는 사역 프로젝트를 선택하신 후 "후원하기" 버튼을 눌러 주세요. 일시 후원과 정기 후원 중 선택하실 수 있으며, 원하시는 금액을 직접 입력하거나 제시된 프리셋 금액을 선택하실 수 있습니다.',
  },
  {
    id: 'f2',
    category: '후원',
  ...
  },
  {
    id: 'f6',
    category: '프로젝트',
    question: '선교사가 프로젝트를 등록하려면 어떻게 해야 하나요?',
    answer:
      '상단 내비게이션의 "프로젝트 만들기"를 통해 신청서를 제출하시면 됩니다. 제출된 프로젝트는 담당자 검토 → 승인자 검토를 거쳐 홈페이지에 게시됩니다. 심사에는 영업일 기준 3~5일이 소요됩니다.',
  },
  {
    id: 'f7',
    category: '프로젝트',
    ...
    answer:
      '목표액에 미달하더라도 모금된 전액은 해당 선교사님의 사역비로 100% 사용됩니다. 단, 프로젝트 기간 종료 후 환불을 원하시는 후원자분께는 개별 연락을 통해 처리해 드립니다.',
  },
  {
    id: 'f8',
    category: '계정',
    ...
    answer:
      '로그인 후 상단 메뉴의 "내 후원"을 클릭하시면 내가 후원한 프로젝트 목록, 후원 금액, 정기 후원 현황 및 기부금 영수증을 한눈에 확인하실 수 있습니다.',
  },
  {
    id: 'f9',
    category: '계정',
...
const FAQ_CATEGORIES = ['전체', '후원', '영수증', '프로젝트', '계정', '결제']
const CONTACT_CATEGORIES = ['후원 문의', '프로젝트 등록', '기부금 영수증', '결제/환불', '계정 문의', '기타']
