        ...
        <div className="lg:col-span-2 bg-card rounded-2xl border border-border shadow-sm overflow-hidden">
          <div className="px-5 pt-5 pb-3 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">색상이 짙을수록 누적 모금액이 높습니다. 마커를 클릭하면 상세 정보를 확인할 수 있습니다.</p>
            </div>
          ...
          <div className="w-full bg-[oklch(0.97_0.01_220)]">
            <ComposableMap
                    ...
                    return (
                      <Geography
                        ...
                        style={{
                          ...
                          hover: {
                            fill: nameEn ? 'oklch(0.45 0.14 195)' : 'oklch(0.88 0 0)',
                            stroke: 'oklch(0.98 0 0)',
                            strokeWidth: 0.5,
                            outline: 'none',
            ...
            <div className="space-y-5 flex-1">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  { label: '활성 캠페인', value: `${selectedData.campaigns}건` },
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border bg-muted/40">
                ...
                <th className="text-right font-semibold text-muted-foreground px-4 py-3">캠페인</th>
              </tr>
            </thead>
            <tbody>
